...
import 'package:training_moveon/screen/products/products_screen/products_screen.dart';
import 'package:training_moveon/screen/routes/material_route/routes_name.dart';
import 'package:training_moveon/screen/routes/material_route/routes_page.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      initialRoute: RoutesPage.goToHomeScreen(),
      routes: {
        ...
        RoutesName.products : (context) => const ProductsScreen(),
      },
    );
  }
}
