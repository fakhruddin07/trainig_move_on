...
import 'package:training_moveon/screen/shared_preference_nd_stream/show_string/sp_and_stream_screen_2.dart';
import 'package:training_moveon/screen/shared_preference_nd_stream/show_string/sp_string_plugin/sp_plugins.dart';
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => const SPAndStreamScreen2(),
                  ),
                );
              },
